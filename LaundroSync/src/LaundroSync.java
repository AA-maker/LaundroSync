...
public class LaundroSync {
     ...
     */
    public ArrayList<Boolean> laundryMachines = new ArrayList<>();

    /**
     * ArrayList containing all drying machines in a space and their status.
     */
    public ArrayList<Boolean> dryingMachines = new ArrayList<>();
     ...
     *
     * @return lengths Integer array containing lengths of two machine lists,
     ...
     */
    public int[] setMachines(int numLaundryMachines, int numDryingMachines) {

        //Checks if lists have already been filled
        if (this.laundryMachines.size() != numLaundryMachines
                && this.dryingMachines.size() != numDryingMachines) {
            ...
            int[] lengths = { this.laundryMachines.size(),
                    this.dryingMachines.size() };

            return lengths;
        } else {
            int[] lengths = { numLaundryMachines, numDryingMachines };
            return lengths;
        }
     ...
     *
     * @return machineCount Integer representing the number of machines for
     *         inputed machineType available, used for testing purposes
     */
    public int checkMachines(String machineType) {
